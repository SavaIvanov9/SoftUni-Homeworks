namespace BasicOperations
{
    ...
    {
        private const int OperationsPerformed = 10000000;

        private const int FirstIntNumber = 1;
        private const int SecondIntNumber = 10;

        private const long FirstLongNumber = 1L;
        private const long SecondLongNumber = 10L;

        private const float FirstFloatNumber = 1.1f;
        private const float SecondFloatNumber = 10.1f;

        private const double FirstDoubleNumber = 1.1;
        private const double SecondDoubleNumber = 10.1;

        private const decimal FirstDecimalNumber = 1.1m;
        private const decimal SecondDecimalNumber = 10.1m;
        ...
        private static void AddIntValues()
        {
            ...
            for (int i = 0; i < OperationsPerformed; i++)
            {
